...
export default function CrisisBanner() {
  return (
    <div className="crisis-banner bg-error text-white py-2 z-40 border-y-2 border-primary/40" style={{ boxShadow: '0 4px 8px rgba(0, 0, 0, 0.5), inset 0 -1px 0 rgba(255, 102, 0, 0.2)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="crisis-banner-row">
