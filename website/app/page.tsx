      ...
      <section className="relative bg-gradient-to-br from-dark via-darker to-dark py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/resources"
              className="bg-accent hover:bg-accent/80 text-white font-bold py-4 px-8 rounded-lg text-lg transition-colors"
            >
              Get Help Now
            </Link>
            <Link
              href="/app"
              className="bg-primary hover:bg-primary/80 text-white font-bold py-4 px-8 rounded-lg text-lg transition-colors"
            >
              Download App
            </Link>
          </div>
      ...
      <section className="py-16 bg-darker">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-dark p-8 rounded-lg border border-primary/20 hover:border-primary/50 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-white">100+ inspirational quotes and affirmations</span>
                </li>
                <li className="flex items-start">
                  <FaStar className="text-primary mt-1 mr-3 flex-shrink-0" />
                  <span className="text-white">Uplifting recovery stories</span>
                </li>
                <li className="flex items-start">
                  <FaStar className="text-primary mt-1 mr-3 flex-shrink-0" />
                  <span className="text-white">Evidence-based advice and tips</span>
                </li>
                <li className="flex items-start">
                  <FaStar className="text-primary mt-1 mr-3 flex-shrink-0" />
                  <span className="text-white">Local Melksham & Wiltshire resources</span>
                </li>
                <li className="flex items-start">
                  <FaStar className="text-primary mt-1 mr-3 flex-shrink-0" />
                  <span className="text-white">20+ mental health topics covered</span>
                </li>
              </ul>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  href="/license"
                  className="bg-secondary hover:bg-secondary/80 text-white font-bold py-3 px-6 rounded-lg inline-block text-center transition-colors"
                >
                  Remove Branding - £20
                </Link>
              </div>
