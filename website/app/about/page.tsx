  ...
  return (
    <div className="space-y-0">
      <section className="page-section bg-texture-1">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white normal-case tracking-normal max-w-4xl">Built from breakdowns, rebuilding, and staying.</h1>
      </section>

      {storyBlocks.map((block) => (
        <section key={block.title} className={`page-section ${block.variant}`}>
      ...
      <section className="page-section bg-texture-2 border-t-4 border-error/70">
        ...
        <p className="text-zinc-100 mb-3 max-w-4xl">
        ...
        <p className="mt-4 text-sm text-zinc-200 max-w-4xl">
