  ...
  return (
    <div className="space-y-0">
      <section className="page-section bg-texture-1">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white mb-4 normal-case tracking-normal max-w-4xl">You don't have to figure this out alone.</h1>
        <p className="text-lg text-zinc-100 max-w-4xl">Sometimes support means talking. Sometimes it means reading something that helps you feel understood.</p>
        <p className="mt-6 text-zinc-100 max-w-4xl">If you're unsure where to start, reach out and we'll help you find the right direction.</p>
      </section>

      <section className="page-section bg-texture-2 border-t-4 border-error/70">
        ...
        <p className="text-lg text-zinc-100 mb-4 max-w-4xl">
        ...
        <p className="text-sm mt-4 text-zinc-200 max-w-4xl">
      ...
      <section className="page-section bg-texture-3">
        ...
        <ul className="space-y-3 text-lg text-zinc-100 max-w-4xl">
